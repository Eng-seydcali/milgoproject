      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            ...
            Professional individuals, including electricians, can significantly benefit from the power of digital marketing to stand out in their respective industries. As a brand, opting for an excellent website design is crucial.
            </p>
          </div>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            ...
            <ul class="leading-8">
              <li><a href="#" class="hover:text-blue-400">Green Electrical</a></li>
              <li><a href="#" class="hover:text-blue-400">Mister Sparky</a></li>
              <li><a href="#" class="hover:text-blue-400">CSI Electrical Contractors</a></li>
              <li><a href="#" class="hover:text-blue-400">Kollmann Electric</a></li>
      ...
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright 2025
            MilgoTechnlogy. All Rights Reserved.
          </div>
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            Made with ❤️ by MilgoTechnlogy.
          </div>
        </div>
      </div>
    </div>
